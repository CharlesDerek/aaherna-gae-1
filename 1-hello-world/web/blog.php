<?php include "includes/header.php";?>
    ...
    <div class="page-hero-section blog-hero">
      <h1 class="intro-header">AAherna blog</h1>
    </div>
    <div class="section">
      <div class="wrapper w-container">
        <div data-ix="fade-up-1" class="page-description"><img src="images/Sep.svg" alt="">
          <div class="page-description-text">Doc, she’s beautiful. She’s crazy, Pain In My Ass, But I love her.. so look at all this.</div>
        </div>
        <div data-ix="fade-up-1" class="categories"><a href="blog.php" class="category-link w--current">All</a>
        ...
        <div class="dynamicgrid" data-ix="cardfloat">
          <?php infoCards("smaller text Prob", "tutorial"); ?>
        </div>
      </div>
    </div>
    <div class="section subscribe-section"><a href="blog.php" class="button big color-1 w-button w--current">View All Posts</a>
